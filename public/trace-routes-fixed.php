<?php
/**
 * Fixed Route Diagnostic - Boots app first
 * Usage: https://athenas.co.in/compliance/ce/public/trace-routes-fixed.php
 */
...
try {
    ...
    // CRITICAL: Boot the application BEFORE using facades
    $report['step2_5_boot'] = 'Booting app...';
    $app->boot();
    $report['step2_5_boot'] = '✓ App booted';
