...
@section('form_title')
CLRA RETURN - HALF-YEARLY RETURN
@endsection
...
[See Rule 81 of the Contract Labour Rules]
@endsection
...
@if($is_nil)
    <div class="nil-block">
        NIL - No contract labour data for this period
    </div>
@else
    ...
    <tr>
        ...
        <td class="signature-right">
            ...
            <div class="signature-label">
                <strong>Signature of Principal Employer</strong>
            </div>
        </td>
    </tr>
</table>
